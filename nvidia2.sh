...
then
    ...
    pip install --upgrade pip setuptools wheel numpy scipy matplotlib ipython jupyter pandas sympy nose scikit-learn scikit-image opencv-python opencv-contrib-python tensorflow-cpu tensorboard keras tensorboard 
